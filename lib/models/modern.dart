...
class _ModernState extends State<Modern> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Modern Professional'),
...
''';
  ...
  void _downloadCVAsPDF() async {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Text(objectiveController.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text("EXPERIENCE", style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold, color: PdfColors.green800)),
              pw.Text(experienceController1.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text(experienceController2.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text(experienceController3.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text("EDUCATION", style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold, color: PdfColors.green800)),
              pw.Text(educationController1.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 10),
              pw.Text(educationController2.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text("SKILLS", style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold, color: PdfColors.green800)),
              pw.Text(skillsController.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text("REFERENCES", style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold, color: PdfColors.green800)),
              pw.Text(referencesController.text, style: pw.TextStyle(fontSize: 16)),
              pw.SizedBox(height: 20),
              pw.Text("CONTACT", style: pw.TextStyle(fontSize: 24, fontWeight: pw.FontWeight.bold, color: PdfColors.green800)),
              pw.Text(contactController.text, style: pw.TextStyle(fontSize: 16)),
            ],
          );
        },
      ),
    ...
    Share.shareFiles([file.path], text: 'Here is my CV');
  }
}
